...
import { AggregateBy, Filter, RankBy } from "./custom.mjs";
import { ClientPerformance } from "../internal/custom/performance.mjs";
export declare class Namespace extends APIResource {
    /**
     * Delete namespace.
     */
     ...
     */
    updateSchema(params?: NamespaceUpdateSchemaParams | null | undefined, options?: RequestOptions): APIPromise<NamespaceUpdateSchemaResponse>;
    /**
...
export interface NamespaceMetadata {
     ...
     */
    schema: {
        [key: string]: AttributeSchemaConfig;
    };
}
/**
 * Query, filter, full-text search and vector search documents.
...
export declare namespace NamespaceMultiQueryResponse {
    interface Result {
        aggregations?: {
            [key: string]: unknown;
        };
 ...
 */
export type NamespaceSchemaResponse = {
    [key: string]: AttributeSchemaConfig;
};
/**
 * The updated schema for the namespace.
 */
export type NamespaceUpdateSchemaResponse = {
    [key: string]: AttributeSchemaConfig;
};
/**
...
export declare namespace NamespaceMultiQueryParams {
    /**
...
export declare namespace NamespaceQueryParams {
    /**
     * The consistency level for a query.
     */
    interface Consistency {
